...
const  InventoryList = ({ inventoryStoreList}) => {
  ...
  return (
     <List>
        {inventoryStoreList && inventoryStoreList.map((item, i) => {
                  return (
                    ...
                    >
                      ...
                      <ListItemSecondaryAction>
                        <IconButton edge="end" aria-label="delete" className={classes.icon} size="medium">
                          {item.draggable ? <ArtTrackIcon /> : <CheckCircleOutlineIcon />}                          
                        </IconButton>
                      </ListItemSecondaryAction>
                    </ListItem>
                  );
